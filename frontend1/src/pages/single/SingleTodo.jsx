  ...
  return (
    <>
      ...
      {data.map((item) => {
        return (
          <>
            <div className="lg:w-[500px] h-[500px] bg-lightblue text-white mt-3  ml-auto mr-auto rounded-lg shadow-lg shadow-blue-500/50 w-[90%] md:w-[70%]">
              <div className="flex justify-center text-[22px] text-center border-b-white p-2 overflow-auto  h-[150px]">
                {" "}
                {item.todoTitle}
              </div>

              <div className="flex text-md justify-center p-2 h-[300px] ">
