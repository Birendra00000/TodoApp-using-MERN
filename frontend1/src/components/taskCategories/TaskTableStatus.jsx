  ...
  return (
    <div className="w-full border border-gray-400 rounded-lg mt-4">
      <ul className=" border-b border border-gray-400  flex pl-0 mb-0">
        <li className="  font-semibold border-r text-center w-[5%] text-[12px] lg:text-[16px]">
          S.N
        </li>
        <li className="p-1 font-semibold text-center border-r  col-span-5 w-[45%] text-[12px] lg:text-[16px]">
          Task Status
        </li>
